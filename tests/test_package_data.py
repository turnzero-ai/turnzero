...
from turnzero.config import get_bundled_blocks_dir, get_bundled_index_path
...
def test_config_helpers_match_cli_helpers():
    from turnzero.cli.base import get_bundled_index_path as cli_bundled_index
    from turnzero.config import get_bundled_index_path as config_bundled_index
